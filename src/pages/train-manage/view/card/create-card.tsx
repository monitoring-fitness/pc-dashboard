...
import { useCreateCard } from '@/pages/train-manage/model/view-model/useCreateCard';
import { Modal } from '@arco-design/web-react';
import { CardForm } from '@/pages/train-manage/component';
import { EntityTrainCard } from '@/pages/train-manage/model/entity/card';
